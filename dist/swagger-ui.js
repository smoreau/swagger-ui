...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.clearSession = function(e) {
      return alert("Clear the session now");
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.formatUrl = function(url) {
      var baseUrl, indexApidocs;
      if (!url.match(/^HTTP/i)) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        invocationUrl = this.formatUrl(invocationUrl);
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.vscSampleJSON = function() {
      var result;
      result = this.model.sampleJSON;
      if (result) {
